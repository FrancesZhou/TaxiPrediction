...
def main():
    ...
    if FLAGS.model=='ResNet':
        ...
        solver = ModelSolver(model, train, val, preprocessing=pre_process,
                ...
                pretrained_model=None, model_path='citybike-cluster-results/model_save/ResNet/', 
                test_model='citybike-cluster-results/model_save/ResNet/model-'+str(FLAGS.n_epochs), log_path='citybike-cluster-results/log/ResNet/', 
        ...
        if FLAGS.model=='ConvLSTM':
            ...
            solver = ModelSolver(model, train, val, preprocessing=pre_process,
                ...
                update_rule=FLAGS.update_rule,
                learning_rate=FLAGS.lr, save_every=FLAGS.save_every, 
                pretrained_model=None, model_path='citybike-cluster-results/model_save/ConvLSTM/', 
                test_model='citybike-cluster-results/model_save/ConvLSTM/model-'+str(FLAGS.n_epochs), log_path='citybike-cluster-results/log/ConvLSTM/')
