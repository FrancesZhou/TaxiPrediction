...
np.save('citybike-10-minutes-results/results/HA/test_target.npy', test_real)
np.save('citybike-10-minutes-results/results/HA/test_prediction.npy', test_predict)
