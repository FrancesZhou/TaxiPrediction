...
all_timestamps_string = all_timestamps_string[:-4416*6]
...
np.save('citybike-10-minutes-results/results/VAR/test_target.npy', test_real)
np.save('citybike-10-minutes-results/results/VAR/test_prediction.npy', test_predict)
