...
for i in range(val_data.shape[0]-output_steps):
    ...
    val_predict.append(results.forecast(val_data_preindex[i:i+lag_order], output_steps))
...
np.save('taxi-10-minutes-results/results/VAR/test_target.npy', test_real)
np.save('taxi-10-minutes-results/results/VAR/test_prediction.npy', test_predict)
