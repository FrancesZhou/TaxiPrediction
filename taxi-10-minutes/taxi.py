...
def main():
    ...
    if FLAGS.model=='ResNet':
        ...
        all_timestamps = gen_timestamps(['2015'], gen_timestamps_for_year=gen_timestamps_for_year_ymdhm)
        ...
        solver = ModelSolver(model, train, val, preprocessing=pre_process,
                ...
                pretrained_model=None, model_path='taxi-10-minutes-results/model_save/ResNet/', 
                test_model='taxi-10-minutes-results/model_save/ResNet/model-'+str(FLAGS.n_epochs), log_path='taxi-10-minutes-results/log/ResNet/', 
        ...
        if FLAGS.model=='ConvLSTM':
            ...
            solver = ModelSolver(model, train, val, preprocessing=pre_process,
                ...
                update_rule=FLAGS.update_rule,
                learning_rate=FLAGS.lr, save_every=FLAGS.save_every, 
                pretrained_model=None, model_path='taxi-10-minutes-results/model_save/ConvLSTM/', 
                test_model='taxi-10-minutes-results/model_save/ConvLSTM/model-'+str(FLAGS.n_epochs), log_path='taxi-10-minutes-results/log/ConvLSTM/')
            ...
            solver = ModelSolver(model, train, val, preprocessing=pre_process,
                ...
                update_rule=FLAGS.update_rule,
                learning_rate=FLAGS.lr, save_every=FLAGS.save_every, 
                pretrained_model=None, model_path='taxi-10-minutes-results/model_save/AttConvLSTM/', 
                test_model='taxi-10-minutes-results/model_save/AttConvLSTM/model-'+str(FLAGS.n_epochs), log_path='taxi-10-minutes-results/log/AttConvLSTM/')
        print('begin training...')
        test_prediction, _ = solver.train(test)
        test_target = np.asarray(test_y)
        #print('test trained model...')
        #solver.test(test)
    np.save('taxi-10-minutes-results/results/'+FLAGS.model+'/test_target.npy', test_target)
    np.save('taxi-10-minutes-results/results/'+FLAGS.model+'/test_prediction.npy', test_prediction)
