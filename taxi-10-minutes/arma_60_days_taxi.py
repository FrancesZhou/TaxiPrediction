...
all_timestamps_string = gen_timestamps(['2015'], gen_timestamps_for_year=gen_timestamps_for_year_ymdhm)
...
print('======================= ARMA for test ===============================')
# test first week of Nov
# test first week of Dec
loss = 0
error_count = 0
run_times = 24*7*6*2
...
index_all[0:1008] = range(1008)
index_all[1008:] = range(4320,4320+1008)
...
np.save('taxi-10-minutes-results/results/ARMA/test_target.npy', test_target)
np.save('taxi-10-minutes-results/results/ARMA/test_prediction.npy', test_prediction)
np.save('taxi-10-minutes-results/results/ARMA/index_all.npy', index_all)
np.save('taxi-10-minutes-results/results/ARMA/error_index.npy', error_index)
